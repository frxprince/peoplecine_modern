(function () {
    var i18n = Object.assign({
        meterUnit: 'เมตร',
        inchUnit: 'นิ้ว',
        millimeterUnit: 'มิลลิเมตร',
        scope: 'สโคป',
        flat: 'ตัดซีน',
        scopeAndFlat: 'สโคป + ตัดซีน',
        scopeScreen: 'จอสโคป',
        flatScreen: 'จอตัดซีน',
        recommendedFlatLens: 'เลนส์ที่แนะนำสำหรับฉายตัดซีน:',
        recommendedScopeLens: 'เลนส์ที่แนะนำสำหรับฉายสโคป:',
    }, window.peoplecineCalculatorI18n || {});
    ...
    function meters(value) {
        return value.toFixed(2) + ' ' + i18n.meterUnit;
    }
        ...
        button.addEventListener('click', function (event) {
            ...
            if (screenType === 'scope') {
                if (printFormat === 'scope' || printFormat === 'both') {
                    ...
                    setText('Lscreen_type', i18n.scopeScreen);
                    setText('Lprint_type', i18n.scope);
                    ...
                    if (printFormat === 'both') {
                        ...
                        setText(
                            'Lmatch',
                            i18n.recommendedFlatLens + ' ' + recommendFlatLens.toFixed(2) + ' ' + i18n.inchUnit +
                                ' (' + (recommendFlatLens / 0.03937008).toFixed(2) + ' ' + i18n.millimeterUnit + ')'
                        );
                    }
                }
            ...
            if (screenType === 'flat') {
                setText('scope_label', i18n.scope);
                ...
                if (printFormat === 'scope') {
                    ...
                    setText('Lscreen_type', i18n.flatScreen);
                    setText('Lprint_type', i18n.scope);
                    setText('Lscreen_width', meters(screenSize));
                    setText('Lscreen_height', meters(screenSize / 2.35));
                    setText('Lthrow_distance', meters(throwDistance * 0.3048));
                ...
                if (printFormat === 'flat' || printFormat === 'both') {
                    ...
                    if (printFormat === 'both') {
                        ...
                        setText(
                            'Lmatch',
                            i18n.recommendedScopeLens + ' ' + recommendScopeLens.toFixed(2) + ' ' + i18n.inchUnit +
                                ' (' + (recommendScopeLens / 0.03937008).toFixed(2) + ' ' + i18n.millimeterUnit + ')'
                        );
                    }
                }
            }
    ...
    function initScreenDesign() {
        ...
        button.addEventListener('click', function (event) {
            ...
            if (width < height) {
                setText('screen_area_width', '0 ' + i18n.meterUnit);
                setText('screen_area_height', '0 ' + i18n.meterUnit);
                return;
            }
