document.addEventListener('DOMContentLoaded', () => {
    ...
    editors.forEach((textarea) => {
        ...
        window.tinymce.init({
            ...
            plugins: 'autolink autoresize charmap code emoticons fullscreen link lists preview searchreplace table visualblocks wordcount',
            toolbar: 'undo redo | blocks fontfamily fontsize | bold italic underline strikethrough | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | blockquote | link table charmap emoticons | removeformat code fullscreen preview',
